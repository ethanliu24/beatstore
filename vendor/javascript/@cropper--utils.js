// @cropper/utils@2.0.0 downloaded from https://ga.jspm.io/npm:@cropper/utils@2.0.0/dist/utils.esm.raw.js
 ...
 */function isString(t){return typeof t==="string"}const Z=Number.isNaN||n.isNaN;
/**
 * Check if the given value is a number.
 * @param {*} value The value to check.
 * @returns {boolean} Returns `true` if the given value is a number, else `false`.
 */function isNumber(t){return typeof t==="number"&&!Z(t)}
/**
 ...
 */function isObject(t){return typeof t==="object"&&t!==null}const{hasOwnProperty:q}=Object.prototype;
/**
 ...
 */function isElement(t){return typeof t==="object"&&t!==null&&t.nodeType===1}const G=/([a-z\d])([A-Z])/g;
/**
 ...
 */function toAngleInRadian(t){const n=parseFloat(t)||0;if(n!==0){const[e="rad"]=String(t).match(W)||[];switch(e.toLowerCase()){case"deg":return n/360*(Math.PI*2);case"grad":return n/400*(Math.PI*2);case"turn":return n*(Math.PI*2)}}return n}const _="contain";const tt="cover";
/**
