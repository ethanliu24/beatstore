// @cropper/element-image@2.0.0 downloaded from https://ga.jspm.io/npm:@cropper/element-image@2.0.0/dist/element-image.esm.raw.js
...
/**
     ...
     */$ready(t){const{$image:s}=this;const i=new Promise(((t,i)=>{const a=new Error("Failed to load the image source");if(s.complete)s.naturalWidth>0&&s.naturalHeight>0?t(s):i(a);else{const onLoad=()=>{r(s,g,onError);t(s)};const onError=()=>{r(s,o,onLoad);i(a)};b(s,o,onLoad);b(s,g,onError)}}));u(t)&&i.then((s=>{t(s);return s}));return i}
/**
