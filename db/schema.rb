...
ActiveRecord::Schema[8.0].define(version: 2026_06_20_154835) do
  ...
  create_table "licenses", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.datetime "discarded_at"
    t.boolean "show_in_licensing_page", default: false
  ...
  create_table "metrics", force: :cascade do |t|
    ...
    t.index ["event_name", "created_at"], name: "index_metrics_on_event_name_and_created_at"
    t.index ["prunes_at"], name: "index_metrics_on_prunes_at"
  ...
  create_table "tracks", force: :cascade do |t|
    ...
    t.datetime "discarded_at"
    t.string "slug"
    t.boolean "purchased_exclusively", default: false
